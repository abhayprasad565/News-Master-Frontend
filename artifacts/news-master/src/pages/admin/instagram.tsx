  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold font-serif tracking-tight">Instagram Operations</h1>
          <p className="text-muted-foreground mt-1">Manage recent posts and delivery failures for Instagram.</p>
        </div>
      </div>
